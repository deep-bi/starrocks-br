...
def test_should_find_partitions_with_specific_baseline_backup(db_with_timezone):
    ...
    partitions = planner.find_recent_partitions(db_with_timezone, "sales_db", "sales_db_20251010_full", group_name="daily_incremental")
...
def test_should_fail_when_invalid_baseline_backup(db_with_timezone):
    ...
    with pytest.raises(ValueError, match="Baseline backup 'invalid_backup' not found"):
        planner.find_recent_partitions(db_with_timezone, "test_db", "invalid_backup", group_name="daily_incremental")
...
def test_should_find_partitions_updated_since_latest_full_backup(mocker, db_with_timezone):
    ...
    partitions = planner.find_recent_partitions(db_with_timezone, "sales_db", group_name="daily_incremental")
...
def test_should_build_full_backup_command_with_wildcard(db_with_timezone):
    ...
    command = planner.build_full_backup_command(db_with_timezone, "monthly_full", "my_repo", "sales_db_20251015_full", "sales_db")
...
def test_should_build_full_backup_command_with_specific_tables(db_with_timezone):
    ...
    command = planner.build_full_backup_command(db_with_timezone, "weekly_dimensions", "my_repo", "weekly_backup_20251015", "sales_db")
...
def test_should_return_empty_command_when_no_tables_in_group(db_with_timezone):
    ...
    command = planner.build_full_backup_command(db_with_timezone, "empty_group", "repo", "label", "test_db")
...
def test_should_return_empty_command_when_no_tables_for_database(db_with_timezone):
    ...
    command = planner.build_full_backup_command(db_with_timezone, "group", "repo", "label", "test_db")
...
def test_should_return_empty_partitions_when_no_group_tables(mocker, db_with_timezone):
    ...
    partitions = planner.find_recent_partitions(db_with_timezone, "test_db", group_name="empty_group")
...
def test_should_return_empty_list_when_no_tables_for_database_in_get_all_partitions(db_with_timezone):
...
def test_find_recent_partitions_handles_wildcard_group(mocker, db_with_timezone):
    ...
    partitions = planner.find_recent_partitions(db_with_timezone, "sales_db", group_name="monthly_full")
